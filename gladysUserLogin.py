...
# def login():
#     """
#     Asks the user for a login (email address) and validates it.
#     Returns the user login (email address) to the gladysUserInterface module.
#     """
#     max_attempts = 3
#     attempts = 0
